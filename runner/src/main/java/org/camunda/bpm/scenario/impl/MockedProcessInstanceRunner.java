 ...
 */
public class MockedProcessInstanceRunner extends ProcessInstanceRunner {

  public MockedProcessInstanceRunner(final MockedCallActivityAction action) {
    ...
    super(null, new ProcessScenario() {
      ...
      @Override
      public Runner runsProcessInstance(String processDefinitionKey) {
        throw new IllegalStateException();
      }
